...
import styles from '../../styles/Interior/gallery.module.css';
import type { InteriorGalleryImage } from './interiorUI';

interface GalleryModalProps {
    isOpen: boolean;
    onClose: () => void;
    images: InteriorGalleryImage[];
    initialIndex: number;
}
...
export function GalleryModal({ isOpen, onClose, images, initialIndex }: GalleryModalProps) {
    ...
    const handleDownload = () => {
        ...
        link.download = activeSlide.imageAlt || `interior-${index + 1}`;
